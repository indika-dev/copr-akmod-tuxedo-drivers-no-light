...
Source0:        %{name}-%{version}/tuxedo-drivers-no-light-kmod.spec
Source1:        %{name}-%{version}/tuxedo-drivers-no-light-kmod.spec.in
Source2:        %{modname}-v%{version}/%{modname}-v%{version}.tar.gz
